...
export const CHESS_PERSONALITIES: Record<string, ChessPersonality> = {
  ...
  fischer: {
    ...
    avatar: '/images/grandmasters/фишер.png',
  ...
  tal: {
    ...
    avatar: '/images/grandmasters/михаил таль.png',
  ...
  capablanca: {
    ...
    avatar: '/images/grandmasters/касабланка.png',
    ...
    locked: true,
    unlockCondition: 'Набери 1600 рейтинг',
    rating: 2740,
    style: {
      aggression: 0.5,
      tactical: 0.6,
  ...
  karpov: {
    ...
    avatar: '/images/grandmasters/карпов.png',
