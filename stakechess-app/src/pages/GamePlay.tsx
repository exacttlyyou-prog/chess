    ...
    >
      ...
      <div className="flex-1 flex flex-col px-4 md:px-8 pt-2 pb-4 md:pb-8">
        ...
        >
          ...
          <div className="glass-card px-4 py-2 flex items-center gap-2 ml-auto bg-gradient-to-br from-green-500/10 to-transparent border-green-500/20">
            <img src="/alfa-icon.svg" alt="" className="h-5" />
            <div>
